...
<div class="student_list_area">
	<div class="student_list fix column">
		<table border="1" class="box">
			<tbody>
				<tr>
					<th><?php _e('Notice Name', 'edu_text_domain');?></th>
					<th><?php _e('Notice Date', 'edu_text_domain');?></th>				
					<th><?php _e('Notice Time', 'edu_text_domain');?></th>				
				...
				<?php 
				  ...
				  $wp_query->query('showposts=30&post_type=post&cat=6'.'&paged='.$paged); 

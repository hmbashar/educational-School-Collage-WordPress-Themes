...
if( !function_exists( 'add_teacher_role' ) ) {
    function add_teacher_role() {
        ...
        add_role( edu_custom_role . '_teacher_panel_manager',
            __( 'Teacher Panel', 'edu_text_domain' ),
 ...
 */
add_action( 'admin_init', 'add_teacher_role_caps' );
 
if( !function_exists( 'add_teacher_role_caps' ) ) {
    function add_teacher_role_caps() {
        ...
        $roles = array( edu_custom_role . '_teacher_panel_manager', 'administrator' );

...
add_action( 'init', 'add_students_role' );
 
if( !function_exists( 'add_students_role' ) ) {
    function add_students_role() {
        ...
        add_role( edu_custom_role . '_students_panel_manager',
            __( 'Students Panel', 'edu_text_domain' ),
 ...
 */
add_action( 'admin_init', 'add_sudents_role_caps' );
 
if( !function_exists( 'add_sudents_role_caps' ) ) {
    function add_sudents_role_caps() {
        ...
        $roles = array( edu_custom_role . '_students_panel_manager', 'administrator' );
